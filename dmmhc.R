# DMMHC basado en bnlearn
# 
# La primera parte del mmpc estatico aplicado al dinamico va a ser hecha adaptando 
# si fuera necesario maxmin-pc.R de bnlearn
# 
# Habra que ejecutarlo tanto para Ne0 como para Ne+, con sus diferentes frames para X
# 
# En Ne0 solo trato CPC0 de cada X(0), en Ne+ trato todo CPt-1, CPCt y CCt+1.
# 
# El hill climbing posterior debera ser adaptado para tener en cuenta las constraints del modelo
 

dmmhc = function(frame) {
